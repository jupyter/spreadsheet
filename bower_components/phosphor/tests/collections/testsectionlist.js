...
var tests;
(function (tests) {
    var SectionList = phosphor.collections.SectionList;
    describe('phosphor.collections - sectionlist', function () {
        describe('SectionList', function () {
            describe('#count', function () {
                it('should get the total number of sections in the list', function () {
            ...
            describe('#size', function () {
                it('should get the total size of all sections in the list.', function () {
                    var obj = new SectionList();
            ...
            describe('#indexOf()', function () {
                it('should find the index of section which covers a given offset', function () {
                    var obj = new SectionList();
                    obj.insert(0, 100, 10);
                ...
                it('should should return -1 if out of range', function () {
                    var obj = new SectionList();
            ...
            describe('#offsetOf()', function () {
                it('should find the offset position of the section at the given index', function () {
                    var obj = new SectionList();
                ...
                it('should be taken as an offset from the end of the list', function () {
                    var obj = new SectionList();
                    expect(obj.offsetOf(0)).to.be(-1);
                    obj.insert(0, 100, 10);
                    expect(obj.offsetOf(-10)).to.be(900);
                });
                it('should return -1 if the index is out of range', function () {
                    var obj = new SectionList();
                    expect(obj.offsetOf(0)).to.be(-1);
                    obj.insert(0, 100, 10);
            ...
            describe('#sizeOf()', function () {
                it('should find the size of the section at the given index', function () {
                    var obj = new SectionList();
                    obj.insert(0, 100, 10);
            ...
            describe('#insert()', function () {
                it('should insert new sections into the list', function () {
                    var obj = new SectionList();
                    expect(obj.size).to.be(0);
                    expect(obj.count).to.be(0);
                    obj.insert(0, 100, 10);
                ...
                it('should offset from the end of the list for negative index', function () {
                    var obj = new SectionList();
                    obj.insert(0, 50, 20);
                    obj.insert(-10, 75, 10);
                ...
                it('should be clamped to the range `[0, list.count]`', function () {
                    var obj = new SectionList();
                    obj.insert(0, 50, 20);
                ...
                it('should be a no-nop for count <= 0', function () {
                    var obj = new SectionList();
                    obj.insert(0, 0, 1000);
                    expect(obj.size).to.be(0);
                    expect(obj.count).to.be(0);
                });
                it('should clamp the size to the range `[0, Infinity]`', function () {
                    var obj = new SectionList();
                    obj.insert(0, 10, -10);
                    expect(obj.size).to.be(0);
                ...
                it('should create list with variable sized sections', function () {
                    var obj = new SectionList();
                    obj.insert(0, 100, 10);
                ...
                it('should create another list with variable sized sections', function () {
                    var obj = new SectionList();
                    obj.insert(0, 75, 10);
                    obj.insert(10, 75, 20);
            ...
            describe('#remove()', function () {
                it('should remove existing sections from the list', function () {
                    var obj = new SectionList();
                    expect(obj.size).to.be(0);
                    expect(obj.count).to.be(0);
                    obj.insert(0, 100, 10);
                ...
                it('should clamp sections to valid range', function () {
                    var obj = new SectionList();
                    obj.insert(0, 100, 10);
                    obj.remove(-120, 30);
                    expect(obj.count).to.be(90);
                ...
                it('should be a no-op if count `<= 0`', function () {
                    var obj = new SectionList();
                    obj.insert(0, 100, 10);
                    obj.remove(0, 0);
                    expect(obj.count).to.be(100);
                ...
                it('should also end up empty', function () {
                    var obj = new SectionList();
                    obj.insert(0, 100, 10);
                    obj.insert(10, 100, 20);
                    obj.remove(125, 50);
            ...
            describe('#resize()', function () {
                it('should resize existing sections in the list', function () {
                    var obj = new SectionList();
                    obj.insert(0, 100, 10);
                    obj.resize(50, 10, 20);
                ...
                it('should clamp the size to `[0, Infinity]', function () {
                    var obj = new SectionList();
                    obj.insert(0, 100, 10);
                    obj.resize(0, 10, -10);
